...
export const getAscendingPozitionIds = (origin?: PozitionIds): ReadonlyArray<PozitionIds> => {
  return getAscendingEnumValues(PozitionIds, origin)
}

export const getDescendingPozitionIds = (origin?: PozitionIds): ReadonlyArray<PozitionIds> => {
  return getDescendingEnumValues(PozitionIds, origin)
}

export const getAscendingPitchIds = (origin?: PitchIds): ReadonlyArray<PitchIds> => {
  return getAscendingEnumValues(PitchIds, origin)
}

export const getDescendingPitchIds = (origin?: PitchIds): ReadonlyArray<PitchIds> => {
